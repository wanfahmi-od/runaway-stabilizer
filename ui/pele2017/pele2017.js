/**
 * Pele2017 UI Extension
 * @class
 */
function Pele2017UIExt() {
    var that = this;

    this._skinName = "pele2017";
    ...
    */
    ...
    this._InitUI = function () {
        ...
        ls.rel = "stylesheet";
        ls.href = "ui/pele2017/pele2017.css";
...
if (!ko.components.isRegistered('pele2017')) {
    ko.components.register('pele2017', {
        viewModel: {
        ...
        template: { require: 'text!ui/pele2017/pele2017.html' }
    });
}

CBTPlayer.RegisterUserInterface('pele2017', Pele2017UIExt);