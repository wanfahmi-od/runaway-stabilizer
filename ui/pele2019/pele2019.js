/**
 * Pele2019 UI Extension
 * @class
 */
function Pele2019UIExt() {
    var that = this;

    this._skinName = "pele2019";
    ...
    */
    ...
    this._InitUI = function () {
        document.title = "Pelesys CBT Player";

        var ls = document.createElement("link");
        ls.rel = "stylesheet";
        ls.href = "ui/pele2019/pele2019.css";
...
if (!ko.components.isRegistered('pele2019')) {
    ko.components.register('pele2019', {
        viewModel: {
...
CBTPlayer.RegisterUserInterface('pele2019', Pele2019UIExt);
