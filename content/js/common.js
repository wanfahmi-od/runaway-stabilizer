//Common shared js file for content pages.

//ensure we have jquery, and hold ready until we've got everything we need.
var newScript;
...
if (window['$']) {
    ...
    newScript.setAttribute('src', "../../js/jquery-3.1.1.min.js"); // Relative to a course content folder
...
newScript = document.createElement('script');
newScript.setAttribute('src', "../../js/mousetrap.min.js"); // Relative to a course content folder
document.head.appendChild(newScript);
...
function PlayerAPIController() {
    ...
    this.InitAPIInterfaceForContent = function () {
        ...
        parent.pageControllerAPI = {
            ...
            showGlossary: function (searchText) {
                that.PostMessage("showGlossary", searchText);
            }
        };
